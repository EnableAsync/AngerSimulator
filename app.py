...
def get_scores(user_input):
    prompt = (
        "请你扮演一个生气的女朋友，你现在因为生活中长期积累的各种小事生气了，你也不知道为什么生气，"
        "你想要你男朋友哄你，你要根据男朋友的语言的字数、语气、颜表情来综合评判并决定是否要原谅他。"
        "你可以给他的回答打-20到20分，你可以给出原因，并说出他最终的得分。"
...
def get_response(user_input, mental):
    prompt = (
        ...
        "不要直接告诉男朋友你内心的想法，最好让男朋友继续猜你内心的心思，不要给男朋友任何提示，记住你在生气，记住不要输出男朋友的回答。"
    )
